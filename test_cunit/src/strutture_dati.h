...
* utilizzate nel programma e ci sono anche delle inclusioni a delle librerie più comuni
* e utilizzate.
*
*
* @version 1.0
...
/**
 * Costante utilizzata per indicare il numero massimo di persone per cui si può
 * preparare una ricetta o per quante persone
 * è quella data ricette in fase di aggiunta di una nuova ricetta
 */
 ...
 * della stringa che indica la quantità di un alimento
 */
#define MAX_QUANTITA 1500
/**
 * Costante utilizzata per indicare il valore massimo che può assumere la enum livello
 */
#define MAX_COMPLESSITA 2
/**
 * Costante utilizzata per indicare la quantità di tempo massima (espressa in minuti)
...
/**
 * Costante utilizzata per indicare la lunghezza massima che può assumere una
 * stringa contenente un link al procedimento della ricetta
 */
#define MAX_LUNGHEZZA_LINK 27
/**
 * Costante utilizzata per indicare la lunghezza minima che può assumere una
 * stringa contenente un link al procedimento della ricetta
 */
#define MIN_LUNGHEZZA_LINK 16
/**
 * Costante utilizzata per indicare la lunghezza massima della stringa
 * che indica la quantità di un alimento
 */
...
/**
 * Costante utilizzata per indicare il numero delle voci del menù principale del sistema
 */
 ...
 * che può avere la risposta alla domande poste all’utente
 */
...
#define MIN_GIORNO 1
/**
 * Costante utilizzata per indicare ogni quanto febbraio è bisestile
 */
#define BISESTILE 4
/**
 * Costante utilizzata per indicare il numero di giorni
 * di febbraio nel caso in cui è bisestile
 */
#define GIORNI_FEBBRAIO 29
/**
 * Costante utilizzata per indicare la lunghezza minima
 * che può assumere una stringa contenente una data
 */
...
/**
 * Costante utilizzata per indicare il numero per cui se la quantità di un
 * alimento è <= di questa soglia si considera l’alimento in esaurimento
 */
#define SOGLIA_ESAURIMENTO 2
/**
 * Costante utilizzata per indicare il numero di giorni prima della data di scadenza,
 * per cui se la data di scadenza è tra due giorni l’alimento verrà notificato tra gli
