...
void test_aggiungi_alimento (void) {
    ...
    CU_ASSERT_EQUAL( aggiungi_alimento("files/elenco_alimenti.bin", alimento_frigo), 1);	        /* file esistente */
...
void test_modifica_alimento (void) {
    ...
    CU_ASSERT_EQUAL( modifica_alimento("files/elenco_alimenti.bin", alimento_frigo), 1);	        /* file esistente */
...
void test_cancella_alimento (void) {
    ...
    CU_ASSERT_EQUAL( cancella_alimento ("files/elenco_alimenti.bin", alimento_frigo), 1);	        /* file esistente */
...
void test_aggiungi_menu_giornaliero (void) {
    ...
    CU_ASSERT_EQUAL( aggiungi_menu_giornaliero ("files/menu_settimanale.bin", menu_pieno, menu_pieno.data_menu), 1);	    /* file esistente */
    CU_ASSERT_EQUAL( aggiungi_menu_giornaliero ("", menu_pieno, menu_pieno.data_menu), 0);							/* file non esistente */
    CU_ASSERT_EQUAL( aggiungi_menu_giornaliero ("files/menu_settimanale.bin", menu_vuoto, menu_vuoto.data_menu), 1);		/* input nullo */
}
...
void test_cancella_menu_giornaliero (void) {
    ...
    CU_ASSERT_EQUAL( cancella_menu_giornaliero ("files/menu_settimanale.bin", 10, data_menu), 1);	    			/* file esistente */
    CU_ASSERT_EQUAL( cancella_menu_giornaliero ("", 10, data_menu), 0);										/* file non esistente */
    CU_ASSERT_EQUAL( cancella_menu_giornaliero ("files/menu_settimanale.bin", NUMERO_UTENTI, data_menu), 1);		/* id_utente massimo */
    CU_ASSERT_EQUAL( cancella_menu_giornaliero ("files/menu_settimanale.bin", 1, data_menu), 1);					/* id_utente minimo */
    CU_ASSERT_EQUAL( cancella_menu_giornaliero ("files/menu_settimanale.bin", -1, data_menu), 1);					/* id_utente errato */
}
...
void test_aggiungi_utente (void) {
    ...
    CU_ASSERT_EQUAL( aggiungi_utente("files/elenco_utenti.bin", "Antonio", 1), 2);	        	/* file esistente */
    CU_ASSERT_EQUAL( aggiungi_utente("", "Antonio", 1), 0);									/* file non esistente */
    CU_ASSERT_EQUAL( aggiungi_utente("files/elenco_utenti.bin", "", 1), 2);						/*nome utente nullo*/
    CU_ASSERT_EQUAL( aggiungi_utente("files/elenco_utenti.bin", "Antonio", NUMERO_UTENTI), NUMERO_UTENTI + 1);	/*id_ultimo_utente massimo*/
    CU_ASSERT_EQUAL( aggiungi_utente("files/elenco_utenti.bin", "Antonio", 0), 1);				/*id_ultimo_utente minimo*/
}

// ASSERZIONI PER IL TEST DELLA FUNZIONE is_utente_esistente()
void test_is_utente_esistente (void) {

    CU_ASSERT_EQUAL( is_utente_esistente ("Antonio","files/elenco_utenti.bin"), 1);	        	/* file e nome utente esistenti */
    CU_ASSERT_EQUAL( is_utente_esistente ("Antonio",""), 0);	        					/* file non esitente */
    CU_ASSERT_EQUAL( is_utente_esistente ("Filippo","files/elenco_utenti.bin"), 0);	        	/* nome utente non esistente */
}

// ASSERZIONI PER IL TEST DELLA FUNZIONE ricerca_utente()
void test_ricerca_utente (void) {

    CU_ASSERT_STRING_EQUAL( ricerca_utente ("files/elenco_utenti.bin", 1 ), "Antonio");	        	/* file e id utente esistenti  */
    CU_ASSERT_EQUAL( ricerca_utente ("", 1 ), NULL);	        							/* file non esistente  */
    CU_ASSERT_EQUAL( ricerca_utente ("files/elenco_utenti.bin", 1000 ), NULL);	        		/* id utente non esistente  */
}
...
void test_cancella_utente (void) {
    ...
    CU_ASSERT_EQUAL( cancella_utente ("files/elenco_utenti.bin", 1 ), 1);	        		/* file e id utente esistenti  */
    CU_ASSERT_EQUAL( cancella_utente ("", 1 ), 0);	        						/* file non esistente  */
    CU_ASSERT_EQUAL( cancella_utente ("files/elenco_utenti.bin", NUMERO_UTENTI ), 1);	    /* id utente massimo  */
    CU_ASSERT_EQUAL( cancella_utente ("files/elenco_utenti.bin", 1 ), 1);	    			/* id utente minimo  */
}
...
void test_aggiungi_ricetta (void) {
    ...
    CU_ASSERT_EQUAL( aggiungi_ricetta("files/elenco_ricette.bin", ricetta_nuova), 1);	        /* file esistente */
...
void test_modifica_ricetta (void) {
    ...
    CU_ASSERT_EQUAL( modifica_ricetta("files/elenco_ricette.bin", ricetta_nuova), 1);	        /* file esistente */
...
void test_cancella_ricetta (void) {
    ...
    CU_ASSERT_EQUAL( cancella_ricetta ("files/elenco_alimenti.bin", ricetta_nuova.id_ricetta), 1);	        /* file esistente */
    CU_ASSERT_EQUAL( cancella_ricetta ("files/nome_file_non_valido.bin", ricetta_nuova.id_ricetta), 0);		/* file non esistente */
    CU_ASSERT_EQUAL( cancella_ricetta ("files/elenco_alimenti.bin", 100), 1);									/*id ricetta errato*/
}
...
void test_aggiungi_a_lista (void) {
    ...
    CU_ASSERT_EQUAL(aggiungi_a_lista("files/lista_spesa.txt", "Marmellata"), 1);	        /* caso valido */
    CU_ASSERT_EQUAL(aggiungi_a_lista(nome_file_non_valido, array_alimenti_pieno[1].nome_alimento), 0);	/* file non esistente */
    CU_ASSERT_EQUAL(aggiungi_a_lista("files/lista_spesa.txt", " "), 1);				/* alimento passato nullo */
    CU_ASSERT_EQUAL(aggiungi_a_lista("files/lista_spesa.txt", "Cipolle"), 0);			/*caso in cui l'alimento e' gia' presente in lista*/
...
void test_cancella_lista_spesa (void) {
    ...
    CU_ASSERT_EQUAL(cancella_lista_spesa("files/lista_spesa.txt"), 1);				/* il file viene cancellato correttamente */
