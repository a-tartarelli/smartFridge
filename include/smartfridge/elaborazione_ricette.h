...
/**
 * Procedura per l'acquisizione di un insieme di ingredienti che poi verranno utilizzati
 * per effettuare la ricerca nel ricettario di una ricette che li contiene
 *
 */
